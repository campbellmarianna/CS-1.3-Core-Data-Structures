...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_matching_patterns(self):
        ...
        assert contains('aaaa', 'aaa') is True # overlapping occurrences
        assert contains('abcabca', 'ca') is True # multiple occurences
    ...
    def test_find_index_with_matching_patterns(self):
        ...
        assert find_index('aaaa', 'aaa') == 0 # overlapping pattern
        assert find_index('abby', 'by') == 2 # overlapping prefix
    ...
    def test_find_index_with_non_matching_patterns(self):
        ...
        assert find_index('xyz', 'xyp') is None # first letters, but not last
        assert find_index('rig', 'riq') is None # first letters, but not last
    ...
    def test_find_all_indexes_with_matching_patterns(self):
        ...
        assert find_all_indexes('zaxzayza', 'za') == [0, 3, 6] # multiple occurences
        assert find_all_indexes('xayazaaa', 'a') == [1, 3, 5, 6, 7] # multiple occurrences
    ...
    def test_find_all_indexes_with_non_matching_patterns(self):
        ...
        assert find_all_indexes('abcd', 'zbc') == [] # not first letter but last two
        assert find_all_indexes('abcd', 'bcy') == [] # first 2 letters, but not last
    ...
    def test_find_all_indexes_with_complex_patterns(self):
        ...
        # Write more test cases that check complex patterns or edge cases
        # You'll need a lot more than this to test your algorithm's robustness
        assert find_all_indexes('cacaw', 'ca') == [0, 2] # multiple occurences
        assert find_all_indexes('coloacoluacola', 'cola') == [10] # overloapping prefix
